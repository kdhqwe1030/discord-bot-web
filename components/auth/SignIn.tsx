      ...
      <div className="w-full">
        <div className="mb-6">
          ...
          <input
            ...
            className="w-full p-3 border-2 border-foreground/20 rounded-md text-sm transition-all duration-200 bg-background text-foreground focus:border-primary focus:outline-none focus:shadow-[0_0_0_3px] focus:shadow-primary/10 placeholder:text-foreground/40"
            required
          />
        </div>
        ...
        <button
          ...
          disabled={isLoading}
          className="w-full p-3 bg-primary text-text-1  border-none rounded-md text-sm font-bold cursor-pointer transition-all duration-200 mt-2 hover:bg-primary/80 hover:-translate-y-0.5 active:translate-y-0 disabled:opacity-50 disabled:cursor-not-allowed"
        >
          {isLoading ? "로그인 중..." : "로그인"}
        </button>
      </div>
